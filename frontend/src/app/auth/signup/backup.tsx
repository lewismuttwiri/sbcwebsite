...
export default function SignUpPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      setIsLoading(true);
      const response: any = await fetch(`${apiUrl}api/auth/register/`, {
        method: "POST",
        headers: {
  ...
  const getErrorMessage = (field: keyof FormData) => {
    ...
    //   "errors" in apiError &&
    //   apiError.errors &&
    //   field in apiError.errors
    // ) {
    //   const errorValue = apiError.errors[field as keyof typeof apiError.errors];
  ...
  //       apiError.errors &&
  //       field in apiError.errors &&
  //       apiError.errors[field as keyof typeof apiError.errors]
  //   );
  // };
  ...
  // Safely get error message from apiError
