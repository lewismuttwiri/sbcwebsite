...
ACCOUNT_FORMS = {
    'signup': 'sbcapp.forms.CustomSignupForm',
}
...
CKEDITOR_5_MEDIA_PATH = "media/django_ckeditor_5/"
...
ASGI_APPLICATION = 'sbcwebsite.asgi.application'
WSGI_APPLICATION = 'sbcwebsite.wsgi.application'
...
# At the bottom of your urls.py file
if DEBUG:
